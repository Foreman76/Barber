...
class BarberStyle(MDApp):
    ...
    def __init__(self, **kvargs):
        super(BarberStyle, self).__init__(**kvargs)
    ...
    def get_application_config(self):
        return super(BarberStyle, self).get_application_config(
    ...
    def set_value_from_config(self):
        self.config.read(os.path.join(self.directory, 'barberstyle.ini'))
    ...
    def show_about(self, *args):
        ...
        self.screen.ids.about.ids.label.text = \
            self.translation._(
                u'[size=20][b]BarberStyle[/b][/size]\n\n'
                u'[b]Version:[/b] {version}\n'
                u'[b]License:[/b] MIT\n\n'
                u'[size=20][b]Developer[/b][/size]\n\n'
                u'[ref=SITE_PROJECT]'
                u'[color={link_color}]Alexr[/color][/ref]\n\n'
                u'[b]Source code:[/b] '
